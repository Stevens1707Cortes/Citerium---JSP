                ...
                <div class="grid gap-4 md:grid-cols-1 lg:grid-cols-1">
                    ...
                    <div class="md:col-span-1 lg:col-span-1" >
                        <div class="h-full lg:w-3/6 md:w-3/5 m-auto mt-3 py-8 px-6 text-center text-gray-600 rounded-xl border border-gray-200 bg-gradient-to-r from-indigo-100 to-cyan-100">
                            <form id="descontarUnidades" method="POST" action="/CiteriumJSP/productosServlet">
                                ...
                                <button class="flex m-auto w-1/4 justify-center rounded-md bg-red-500 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"" type="submit">Descontar</button>
                            </form>
                        </div>
                    </div>
                    <div class="md:col-span-1 lg:col-span-1" >
                        <div class="h-full lg:w-3/6 md:w-3/5 m-auto mt-3 py-8 px-6 text-center text-gray-600 rounded-xl border border-gray-200 bg-gradient-to-r from-indigo-100 to-cyan-100">
                            <form id="eliminarProducto" method="POST" action="/CiteriumJSP/productosServlet">
