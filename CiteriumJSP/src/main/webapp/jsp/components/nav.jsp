...
<nav class="bg-gradient-to-r from-slate-900 to-indigo-900 ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] overflow-y-auto">
    <aside>
        <div>
            ...
            <div class="mt-8 text-center">
                <img src="../img/usuario.png" alt="" class="w-10 h-10 m-auto rounded-full object-cover lg:w-28 lg:h-28">
                    <h5 class="hidden mt-4 text-xl font-semibold text-white lg:block">{Nombre Usuario}</h5>
            ...
            <ul class="space-y-2 tracking-wide mt-8">
                <li>
                    <a href="#" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-indigo-400">
                        ...
                        <span class="-mr-1 font-medium">Citerium</span>
                    </a>
                </li>
                <li>
                    <a href="homeInventario_SistemaPos.html" class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group">
                ...
                <li>
                    <a href="homeProducto_SistemaPos.html" class="px-4 py-3 flex items-center space-x-4 rounded-md text-white group">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <li>
                    <a href="homeVentas_SistemaPos.html" class="px-4 py-3 pb-5 flex items-center space-x-4 rounded-md text-white group">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
            <a href="index.html" class="px-4 py-3 flex items-center space-x-4 rounded-md text-red-600 group">
